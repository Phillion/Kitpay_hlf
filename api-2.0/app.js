...
//각각의 과정이 실행될 때마다 jwt에 대한 보안 확인
//각각의 과정이 실행될 때마다 로그인 상태인지에 대한 확인
...
//단순히 실행하기만 하면 되는 기능(거래, 생성 등)
app.post('/channels/:channelName/chaincodes/:chaincodeName', async function (req, res) {//포스트형태로 구별?
    try {
...
//호출 뒤 특정 자료를 받아야 하는 기능(상품권 조회, 거래 내역 조회 등)
...
//qscc transaction on chaincode on target peer
//시스템 자체에 관련된 기능(트랜잭션, 블록체인 데이터)
